pipeline {
    ...
    stages {
        ...
        stage ("Helm install") {
            steps {
               script{
                    sh "helm upgrade --install mychart ./mychart --set image.repository=827648740654.dkr.ecr.us-east-1.amazonaws.com/my-docker-repo@sha256:267771600365c30b6f077905efd76f0a1f462765cdaea69fc63539df2950f29c,image.pullPolicy=Always --namespace helm-deployment"
